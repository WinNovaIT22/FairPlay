...
const Home = async () => {
  ...
  return (
    ...
    <div className="flex justify-center p-4 text-xl font-black bg-zinc-700 relative">
      <div className="absolute inset-0" style={{ backgroundImage: `url(${AdminCover.src})`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'repeat', opacity: '20%', backgroundSize: '8%' }}></div>
        {session?.user.firstname}<Chip className="ml-2" color="success" size="md" variant="flat">Ylläpitäjä</Chip>
      </div>
